...
// TODO: FOR NOW ONLY TEST OF GET METHOD, T IS TO CHANGE
const loginRouterTest = new express.Router();
...
loginRouterTest.get(``, asyncMiddleware(async (req, res) => {
  const data = {
    payload: `it works`
  };
  res.send(data);
...
// TODO: CHANGE NAME
module.exports = { loginRouterTest };
